...
from episode_visualisation import visualise_episode_interaction, visualize_state_combination
...
async def run_experiment(config_id, agents, grid_label, camera_offset, screenshot_alpha, max_game_length, num_game_env):
        ...
        for agent_type, agent_class in agents.items():
            for env_type, num_games in num_game_env.items():
                for game_num in range(1, num_games + 1):
                    ...
                    config = util.expand_config_file(experiment_path, grid_label, camera_offset, screenshot_alpha)
...
if __name__ == "__main__":
    ...
    experiment_id = asyncio.run(run_experiment(config_id, agents, grid_label, camera_offset, screenshot_alpha, max_game_length, num_game_env))
