...
color_codes = {
  "start": {
    ...
    "color": "grey",
    "rgb": [141, 153, 174],
    "comment": "Initial checkpoint_state. Only used for post-visual"
  },
  "active_1": {
    "type": "active",
    "color": "blue",
    "rgb": [82, 138, 174],
    "comment": "Productive current checkpoint_state (progress towards goal)"
  },
  "active_0": {
    "type": "active",
    "color": "orange",
    "rgb": [255, 165, 0],
    "comment": "Unproductive current checkpoint_state (no progress, but not failure). Only used for post-visual"
  },
  "last": {
    "type": "last",
    "color": "blue",
    "rgb": [82, 138, 174],
    "comment": "Last active checkpoint_state before episode end.Only used for post-visual"
  },
  "past": {
    "type": "past",
    "color": "grey",
    "rgb": [141, 153, 174],
    "comment": "Past checkpoint_state"
  },
  "goal_1": {
    "type": "goal",
    "color": "green",
    "rgb": [100, 191, 106],
    "comment": "Correct goal checkpoint_state (agent successfully identifies goal)"
  },
  "goal_0": {
    "type": "goal",
    "color": "red",
    "rgb": [242, 92, 84],
    "comment": "Incorrect goal checkpoint_state (agent misidentifies goal). Only used for post-visual"
  }
}
...
def render_schematic(current_board_state, grid_size=4):
    """
    Render a schematic representation of the board checkpoint_state and return it as a PIL image object.
    Adds text labels with chess coordinates in unoccupied cells.

    Args:
        current_board_state (list of dict): Board checkpoint_state containing body, color, and current coordinates.
