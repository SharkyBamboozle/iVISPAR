...
from src_python.core.experiment.tmp import experiment_utilities as util
from webgl_socket_server import run_socketserver_in_background
from web_server import run_WebSocket_server_in_background
from src_python.core.experiment.tmp.init_experiment_components import init_env, init_agent, init_game
from src_python.core.experiment.tmp.action_perception_loop import initialize_connection, interact_with_server as action_perception_loop
...
if __name__ == "__main__":
    ...
    params = util.load_params_from_json('test_rotation.json')
