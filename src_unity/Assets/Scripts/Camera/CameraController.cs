...
public class CameraController : MonoBehaviour
{
    ...
    public void SetPosition(float x, float z,float gridHeight)
    {
        ...
        {
            ExperimentData laodedData = ExperimentManager.Instance.loadedExperimentData;
    ...
    void OnGUI() {
        if(ExperimentManager.Instance.humanExperiment && !ExperimentManager.Instance.loadedExperimentData.use_rendering)
        {
