...
public class CaptureCamera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(EventHandler.Instance != null)
        {
            ...
            alpha = ExperimentManager.Instance.loadedExperimentData.screenshot_alpha;
    ...
    IEnumerator RecordFrameFromTexture()
    {
        ...
        if(!ExperimentManager.Instance.loadedExperimentData.use_rendering && boardSatus == "")
        {
    ...
    void OnGUI()
    {
        if(ExperimentManager.Instance.loadedExperimentData.use_rendering && ExperimentManager.Instance.humanExperiment)
        {
            if (userPhoto != null)
            {
                if(imageToggle)
        ...
        else if (!ExperimentManager.Instance.loadedExperimentData.use_rendering && ExperimentManager.Instance.humanExperiment)
        {
            if (boardSatus != "")
            {
                if(imageToggle)
