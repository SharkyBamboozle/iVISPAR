...
public class ExperimentManager : MonoBehaviour
{
    ...
    public ExperimentData loadedExperimentData;
    ...
    public void Reset() {
        loadedExperimentData = new ExperimentData();
    ...
    public void SetupExperiment(DataPacket setup_data)
    {
        ...
        SceneManager.LoadScene(loadedExperimentData.experiment_type, LoadSceneMode.Single);
    }
    ...
    public void Deserialize(string config)
    {
        ...
        if (loadedExperimentData != null)
        {
            Debug.Log($"Experiment ID: {loadedExperimentData.experiment_id}");
            Debug.Log($"Number of landmarks: {loadedExperimentData.board_data.Length}");
        }
        else
